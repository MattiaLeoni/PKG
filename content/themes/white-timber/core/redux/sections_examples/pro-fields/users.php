...
Redux_Users::set_profile(
	...
	array(
		'id'       => 'demo-users',
		'title'    => esc_html__( 'Cool Options', 'white-theme' ),
		'style'    => 'wp',
		'sections' => array(
			array(
				'title'  => esc_html__( 'Home Settings', 'white-theme' ),
				'icon'   => 'el-icon-home',
				'fields' => array(
					array(
						'id'    => 'user-text',
						'type'  => 'text',
						'title' => esc_html__( 'Input 1', 'white-theme' ),
					),
					array(
						'id'       => 'user-text-2',
						'type'     => 'text',
						'required' => array( 'user-text', '=', 'two' ),
						'title'    => esc_html__( 'Input 2', 'white-theme' ),
					),
					array(
						'id'    => 'user-text-3',
						'type'  => 'text',
						'title' => esc_html__( 'Input 3', 'white-theme' ),
					),
					array(
						'id'       => 'webFonts',
						'type'     => 'media',
						'title'    => esc_html__( 'Web Fonts', 'white-theme' ),
						'compiler' => 'true',
						'mode'     => false,
					...
					array(
						...
						'type'     => 'section',
						'title'    => esc_html__( 'Media Options', 'white-theme' ),
						'subtitle' => esc_html__( 'With the "section" field you can create indent option sections.', 'white-theme' ),
						'indent'   => true,
					),
					array(
						'id'       => 'mediaurl',
					...
					array(
						'id'      => 'slider1bDOVY23',
						'type'    => 'slider',
						'title'   => esc_html__( 'JQuery UI Slider Example 1', 'white-theme' ),
						'desc'    => esc_html__( 'JQuery UI slider description. Min: 1, max: 500, step: 3, default value: 45', 'white-theme' ),
						'default' => '46',
						'min'     => '1',
						'step'    => '3',
						'max'     => '500',
			...
			array(
				'title'  => esc_html__( 'Home Layout', 'white-theme' ),
				'icon'   => 'el-icon-home',
				'fields' => array(
					array(
						'id'       => 'homepage_blocks',
